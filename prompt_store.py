def get_sales_strategy_prompt(website, month, category_selected, events):
    ...
    suggest marketing campaigns to increase sales by leveraging the following events in different geographical regions of India for below given events only:
    {events_str}
